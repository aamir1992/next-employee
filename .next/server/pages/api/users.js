...
async function handler(req, res) {
    ...
    switch(method){
        case "GET":
            (0,_database_controller__WEBPACK_IMPORTED_MODULE_1__/* .getUsers */ .Rf)(req, res);
            break;
        case "POST":
            (0,_database_controller__WEBPACK_IMPORTED_MODULE_1__/* .postUser */ .l1)(req, res);
            break;
        case "PUT":
...
var __webpack_exports__ = __webpack_require__.X(0, [583], () => (__webpack_exec__(641)));
